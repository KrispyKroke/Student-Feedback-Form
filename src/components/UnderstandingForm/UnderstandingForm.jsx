...
function UnderstandingForm() {
    ...
    return (
        <>
            ...
            <button className="prevBtn" onClick={() => history.push('/feeling')}>Previous</button>
            <input className="feedback" type="number" value={currentUnderstanding} onChange={event => setCurrentUnderstanding(event.target.value)} />
            <button className="nextBtn" onClick={submitUnderstanding}>Next</button>
        </>
    );
}
